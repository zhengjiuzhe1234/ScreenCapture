...
public class CaptureScreen extends JFrame implements ActionListener {
    ...
    private void initOther(){
        jtp=new JTabbedPane(JTabbedPane.TOP,JTabbedPane.SCROLL_TAB_LAYOUT);//标签位置
    }
    private void initWindow(){
        ...
        jl.setFont(new Font("黑体",Font.BOLD,40));//设置字体
        ...
        java.addActionListener(this);//添加监听器
        ...
        this.setAlwaysOnTop(true);//总是显示在最上面
